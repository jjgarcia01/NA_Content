...
operation:
  ...
  inputs:
    ...
    - api_url:
        private: true
        default: "${get_sp('api_url')}"
    - login_url:
        private: true
        default: "${get_sp('login_url')}"
    - api_payload:
        private: true
        default: |-
          ${'''{
